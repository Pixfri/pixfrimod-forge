...
public class ModBlockStateProvider extends BlockStateProvider {
    public ModBlockStateProvider(DataGenerator gen, ExistingFileHelper exFileHelper) {
        super(gen, PixfriMod.MOD_ID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlock((DoorBlock) ModBlocks.EBONY_DOOR.get(), new ResourceLocation(PixfriMod.MOD_ID, "block/ebony_door_bottom"),
                new ResourceLocation(PixfriMod.MOD_ID, "block/ebony_door_top"));
        ...
        axisBlock((RotatedPillarBlock) ModBlocks.STRIPPED_EBONY_LOG.get(), new ResourceLocation(PixfriMod.MOD_ID, "block/stripped_ebony_log"),
                new ResourceLocation(PixfriMod.MOD_ID, "block/stripped_ebony_top"));
        axisBlock((RotatedPillarBlock) ModBlocks.STRIPPED_EBONY_WOOD.get(), new ResourceLocation(PixfriMod.MOD_ID, "block/stripped_ebony_log"),
                new ResourceLocation(PixfriMod.MOD_ID, "block/stripped_ebony_top"));
        ...
        simpleBlock(ModBlocks.POTTED_PINK_ROSE.get(), flowerPotCross(ModBlocks.PINK_ROSE.get().getRegistryName().getPath()));
    ...
    private ConfiguredModel[] states(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(block.getAgeProperty()),
                new ResourceLocation(PixfriMod.MOD_ID, "block/" + textureName + state.getValue(block.getAgeProperty()))));
